...
public class uw01_E1 {
    ...
    public static void main(String[] args) {
        ...
        Box hbox4 = Box.createHorizontalBox(); //水平箱2
        JLabel label4 = new JLabel("メールアドレスまたはパスワードが正しくありません。");
        label4.setForeground(Color.red);
        hbox4.add(label4);

        Box vbox = Box.createVerticalBox(); //创建一个垂直箱
        Component vStrut1 = Box.createVerticalStrut(10);
        Component vStrut2 = Box.createVerticalStrut(15);
        Component vStrut3 = Box.createVerticalStrut(30);
        Component vStrut4 = Box.createVerticalStrut(15);
        vbox.add(vStrut3);
