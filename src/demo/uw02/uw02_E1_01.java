...
public class uw02_E1_01 {
    ...
    public static void main(String[] args) {
        ...
        //JOptionPane.showMessageDialog(null, "九時まで出勤できないので。\n" +"　九時出勤お願いします。\n","通知", JOptionPane.ERROR_MESSAGE);
        Object[] options ={ "はい"};
        int m = JOptionPane.showOptionDialog(null, "九時まで出勤できないので。\n九時出勤お願いします。\n", "確認通知",JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE, null, options, options[0]);
